import { ConfirmDebtRequestCommand } from '@oumi-package/movement/lib/application';
...
export const confirmDebtRequestPutController: Oumi.Controller<
  express.Handler
> = container => (req, res, next) =>
  container
    .get<CommandBus>(SERVICE_ID.BUS.SYNC_COMMAND)
    .dispatch(new ConfirmDebtRequestCommand(req.body))
    .then(() => {
